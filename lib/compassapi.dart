...
class _CommunityPassApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is RegisterBasicUserResult) {
      buffer.putUint8(128);
...
class CommunityPassApi {
  ...
  Future<SaveBiometricConsentResult> saveBiometricConsent(String arg_reliantAppGUID, String arg_programGUID) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.CommunityPassApi.saveBiometricConsent', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_reliantAppGUID, arg_programGUID]) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<RegisterUserWithBiometricsResult> getRegisterUserWithBiometrics(String arg_reliantAppGUID, String arg_programGUID, String arg_consentId) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.CommunityPassApi.getRegisterUserWithBiometrics', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_reliantAppGUID, arg_programGUID, arg_consentId]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
  ...
  Future<RegisterBasicUserResult> getRegisterBasicUser(String arg_reliantAppGUID, String arg_programGUID) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
  ...
  Future<WriteProfileResult> getWriteProfile(String arg_reliantAppGUID, String arg_programGUID, String arg_rId, bool arg_overwriteCard) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.CommunityPassApi.getWriteProfile', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_reliantAppGUID, arg_programGUID, arg_rId, arg_overwriteCard]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
  ...
  Future<WritePasscodeResult> getWritePasscode(String arg_reliantAppGUID, String arg_programGUID, String arg_rId, String arg_passcode) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.CommunityPassApi.getWritePasscode', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_reliantAppGUID, arg_programGUID, arg_rId, arg_passcode]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
